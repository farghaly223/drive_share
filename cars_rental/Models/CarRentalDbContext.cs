...
public partial class CarRentalDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Car>(entity =>
        {
            ...
            entity.Property(e => e.CarType).HasMaxLength(50).HasColumnName("car_type");
            ...
            entity.Property(e => e.RentalPrice).HasPrecision(10, 2).HasColumnName("rental_price");
        ...
        modelBuilder.Entity<CarImage>(entity =>
        {
            ...
            entity.Property(e => e.IsMain).HasDefaultValueSql("'0'").HasColumnName("is_main");
        ...
        modelBuilder.Entity<Notification>(entity =>
        {
            ...
            entity.Property(e => e.CreatedAt)
                ...
                .HasColumnType("timestamp")
                .HasColumnName("created_at");
            entity.Property(e => e.IsRead).HasDefaultValueSql("'0'").HasColumnName("is_read");
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.CreatedAt)
                ...
                .HasColumnType("timestamp")
                .HasColumnName("created_at");
            entity.Property(e => e.DriverLicenseUrl).HasMaxLength(255).HasColumnName("driver_license_url");
            entity.Property(e => e.Email).HasMaxLength(150).HasColumnName("email");
            entity.Property(e => e.IsLicenseVerified).HasDefaultValueSql("'0'").HasColumnName("is_license_verified");
            entity.Property(e => e.IsSuspended).HasDefaultValueSql("'0'").HasColumnName("is_suspended");
            ...
            entity.Property(e => e.CanAddCars)
                .HasDefaultValueSql("'1'")
                .HasColumnName("can_add_cars");

            entity.Property(e => e.CanRentCars)
                .HasDefaultValueSql("'1'")
                .HasColumnName("can_rent_cars");
        });
